...
def main():
    ...
    TIME_LIMIT = 3600   # time limit in seconds, 60 MINS
    depth_limit = 0
    start_time = time.time()
    explored_node_count = 0
    max_node_in_memory = 0
    min_left_peg = 32   # minimum number of remaining pegs, initially set to 32 since there are 32 pegs in the board
